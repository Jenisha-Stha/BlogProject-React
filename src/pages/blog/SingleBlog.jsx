        ...
        <div className="flex flex-col md:flex-row -mx-4">
            <div className="md:flex-1 px-4">
                ...
                <div className="flex -mx-2 mb-4">
                    <div className="w-1/2 px-2">
                       <Link to="/blog/edit"> <button className="w-full bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700">Edit</button>
                       </Link>
                    </div>
                    <div className="w-1/2 px-2">
            ...
            <div className="md:flex-1 px-4">
                ...
                <div className="flex mb-4">
                    ...
                    <div>
                        <span className="font-bold text-gray-700 dark:text-gray-300">Publlished at:</span>
